...
// - helpers.calculate_body_angles: all 8 joints must pass confidence / finite / |coord|<=1e6 before angles exist
// - fall._is_fall: torso > torso_threshold AND (left_leg > leg_threshold OR right_leg > leg_threshold)
// Angles use the same vector math as Python: angle between (segment vector) and vertical (0, -1), acute 0–90°.
